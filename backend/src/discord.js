...
export class DiscordManager {
  ...
  async join(id) {
    ...
    const guild = runtime.client.guilds.cache.get(runtime.cfg.guildId); if (!guild) throw new Error("Discord-Server wurde nicht gefunden");
    ...
    runtime.voice.on("stateChange", (_oldState, newState) => {
      ...
      runtime.voiceRecovering = true; runtime.voiceRecoveryTimer = setTimeout(() => {
