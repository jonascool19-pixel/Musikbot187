...
const blank=()=>({version:2,users:[],sessions:[],playlists:[],connections:[],settings:{botName:'MusikBot187',theme:'dark',accent:'#7c3aed',output:'none',outputId:null,spotifyClientId:'',spotifySecret:'',spotifyRedirectUri:'',spotifyAccessToken:'',spotifyRefreshToken:'',spotifyAccessTokenExpiresAt:0,spotifyScopes:[],marqueeSpeed:45,marqueeTextColor:'#eef2ff',marqueeBackground:'#171e2d',autoplayEnabled:false,autoplayMode:'similar',autoplayPlaylistIds:[],autoplayQueueTarget:10,maintenanceEnabled:false,maintenanceTime:'04:30',maintenanceTimezone:'Europe/Berlin',maintenanceLastRun:''},listeningProfile:{version:2,tracks:[],preferredStyles:[],blockedStyles:[]},networkHistory:[],networkTracker:{rx:null,tx:null,sampledAt:null},resourceHistory:[],playbackResume:null,diagnostics:[]});
export class Store {
  ...
  async load(){
    ...
    this.data={...defaults,...saved,settings:{...defaults.settings,...(saved.settings||{})},listeningProfile:{...defaults.listeningProfile,...savedProfile,version:2,tracks:Array.isArray(savedProfile.tracks)?savedProfile.tracks.slice(-200):[],preferredStyles:Array.isArray(savedProfile.preferredStyles)?savedProfile.preferredStyles.slice(0,20):[],blockedStyles:Array.isArray(savedProfile.blockedStyles)?savedProfile.blockedStyles.slice(0,20):[]},networkHistory:Array.isArray(saved.networkHistory)?saved.networkHistory.slice(-400):[],networkTracker:{...defaults.networkTracker,...(saved.networkTracker||{})},resourceHistory:Array.isArray(saved.resourceHistory)?saved.resourceHistory.slice(-2016):[]};
