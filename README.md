...
Die frühere Sammelseite **Einstellungen** wurde vollständig aufgeteilt: **Instanzen** enthält ausschließlich Discord- und TeamSpeak-Konfigurationen, während Spotify einen eigenen Navigationspunkt besitzt. **Automatische Wiedergabe** ist ebenfalls eine eigenständige Seite. Dort können mehrere Playlists in einer sichtbaren Reihenfolge ausgewählt und endlos im Kreis abgespielt werden. Alternativ erstellt der persönliche Musikmix aus dem aktuellen Titel und der lokalen Hörhistorie abwechslungsreiche YouTube-Vorschläge, vermeidet bereits vorbereitete beziehungsweise kürzlich verwendete Titel und hält 3 bis 20 Titel in der Warteschlange bereit. Ein Titel wird erst nach ungefähr 30 Sekunden tatsächlicher Wiedergabe in das lokale Profil aufgenommen. Das Profil bleibt ausschließlich im CT, zeigt gelernte Titel und erkennbare Stilrichtungen und kann direkt im Dashboard zurückgesetzt werden.
