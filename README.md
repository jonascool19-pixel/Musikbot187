...
Der Installer unterstützt Debian/Ubuntu mit `apt-get`, installiert die benötigten Systempakete, richtet Node.js 22 ein, installiert den Bot und aktiviert den Systemdienst `musikbot187`.
