...
# The service is sandboxed with NoNewPrivileges, so sudo cannot be used from the bot process.
# Install a tiny root-owned UNIX-socket controller instead and give the bot a dedicated group.
