...
Automatisiert geprüft werden Importierbarkeit, Setup/Login/Session, Rechte und 403-Verträge, Queue/Player-Zustand, Playlists, Settings/Theme, Secret-Redaction, Uploadheader, SSRF-Policy, Monitoring, Installer-Syntax und Systemd-Härtung. Dazu kommen Verträge für Node/EJS und `bestaudio` bei YouTube/Spotify, die Auswahl der höchsten gemeldeten Radio-Bitrate, 128-kbit/s-Opus für Discord, die aktuelle bigFM-URL und das explizite Betreten eines Discord-Voice-Channels. Die Audioprüfungen decken die kontinuierliche Lautstärke-Pegelrampe und das Unterdrücken wiederholter Discord-Transportbefehle ab. Wartungstests prüfen Zeitzone, Einmal-pro-Tag-Sperre, Snapshot/Wiederherstellung und die gezielte Bereinigung abgebrochener Uploadreste. Browserprüfungen decken Setup, Auth, Navigation, Themes, automatische Suche mit 25 simulierten Treffern ohne horizontales Scrollen, Laufzeit/Gesamtdauer, den kompakten Diagnose-Scrollbereich, den täglichen Zeitplan, den Voice-Button und das Kopieren realer Diagnoseeinträge ab.
