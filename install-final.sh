...
PINNED_COMMIT="a0cf1b172108f65f3753eaa7b2dd9e4b7253ec19"
...
# Do not create or request the web account in the shell installer. The account
# is intentionally empty until the protected first-run wizard creates it.
WEB_USER=""
WEB_PASSWORD=""
