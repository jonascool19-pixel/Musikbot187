...
if ! command -v apt-get >/dev/null 2>&1; then echo "Unterstützt: Debian/Ubuntu mit apt-get."; exit 1; fi
$SUDO apt-get update -y
$SUDO apt-get install -y git curl ffmpeg python3 ca-certificates
