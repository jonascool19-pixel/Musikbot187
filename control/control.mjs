...
const commands={restart:['systemctl',['restart','musikbot187.service']],stop:['systemctl',['stop','musikbot187.service']],reboot:['systemctl',['reboot']],poweroff:['systemctl',['poweroff']]};
